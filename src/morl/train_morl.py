...
from sac_population import SAC_Population
...
if __name__=='__main__':
    ...
    # pop_list = [(i, 200000) for i in range(141, 151)]
    pop_list = [(4, i) for i in range(200000, 290000+1, 10000)]
    ...
    for i in range(pop_size):
        ...
        sac_model.load4pop(path=model_path, run_id=pop_list[i][0], iter_id=pop_list[i][1])
        sac_population.ca[i][0] = sac_model
